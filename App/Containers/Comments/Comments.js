...
import {SafeAreaView, Keyboard, Text, TextInput, Dimensions, ScrollView, View, Image, TouchableOpacity, TouchableHighlight, StyleSheet} from 'react-native';
import firebase from 'react-native-firebase';
import { almostWhite, highlightGreen, darkGray, optionLabelBlue, rejectRed, lightGray } from '../../colors';
                    ...
                    (comment) => (
                        <TouchableOpacity key={comment} style={[styles.commentContainer, {backgroundColor: showDeleteRow ? almostWhite : '#fff'}]} onLongPress={()=>this.setState({showDeleteRow: true})}>
                            ...
                            <View style={styles.commentPicAndTextRow}>
                                ...
                                :
                                <Image style= {styles.commentPic} source={ Images.logo }/>
                                }
