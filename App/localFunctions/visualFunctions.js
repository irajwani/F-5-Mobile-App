...
import { Animated, Easing, View, TouchableWithoutFeedback, Keyboard, TouchableOpacity, Text, TextInput, Platform, StyleSheet, ActivityIndicator } from 'react-native';
    ...
    return (
      <Animated.View style={[styles.loadingIndicatorContainer, {transform: [{ rotate: RotateData }],}]}>
        <View style={styles.shiftPointOfOriginForLoadingIndicator}>
          <Svg height={"70%"} width={"70%"} fill={color} viewBox="0 0 511.99905 511">
...
const MarketplaceIcon = ({strokeWidth, focused}) => (
  <View style={{width: 30, height: 30, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 3}}>
    <Svg height={"100%"} width={"100%"} fill={!focused ? "black" : 'black'} viewBox={"0 0 400 400"}>
        ...
        stroke={!focused ? "black" : Colors.tertiary}
        strokeWidth={strokeWidth}
        />
...
inputText: { fontFamily: 'Avenir Next', fontSize: 16, fontWeight: "700", color: "#e4e4e4"},
